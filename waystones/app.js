...
function App() {
  ...
  const rarityCapExceeded = packState.active && packState.value >= 60 && anyRarityActive || packState.active && iirState.active && !rarityState.active && iirState.value + packState.value >= 95 || packState.active && rarityState.active && !iirState.active && rarityState.value + packState.value >= 95 || allThreeActive && iirState.value + rarityState.value >= 100 && packState.value >= 15 || allThreeActive && packState.value >= 30 || budgetTotal > 130 || iirState.active && rarityState.active && iirState.value >= 100;
  function toggle(i) {
