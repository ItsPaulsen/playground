...
const __TWEAKS_STYLE = `
  .twk-panel,.twk-reopen{
    --bg:rgba(253,253,251,.80);--text:#1c1917;--bd:rgba(0,0,0,.10);
    ...
    --fld-bd:rgba(28,25,23,.15);--fld-bdf:rgba(0,0,0,.24);--fld-surf:rgba(253,253,251,.05);
  ...
  html[data-theme="dark"] .twk-reopen{
    ...
    --fld-bd:rgba(253,253,251,.15);--fld-bdf:rgba(255,255,255,.24);--fld-surf:rgba(250,250,249,.05);
