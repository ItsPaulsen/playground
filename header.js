(function () {
  // Embed mode: iframe thumbnail — hide all chrome, let the experiment fill the frame
  if (new URLSearchParams(location.search).has('embed')) {
    var es = document.createElement('style');
    es.textContent = ':root{--header-h:0px!important}#site-nav,#site-menu,.skip-link,.twk-panel,.twk-reopen,.twk-footer{display:none!important}';
